...
/**
 * Screen for nRootTag (Find My Network Abuse).
 *
 * Exploits Apple's Find My network for device tracking. Scans for Find My
 * beacons, broadcasts spoofed tags, and associates targets with the Find My
 * network.
 *
 * @param viewModel State holder for nRootTag logic.
 */
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun NRootTagScreen(viewModel: NRootTagViewModel) {
        ...
        Column(
            ...
            Text(
                text = "Exploits Apple's Find My network for device tracking. " +
                        "Scans for Find My beacons, broadcasts spoofed tags, " +
                        "and associates targets with the Find My network.",
            ...
            ExposedDropdownMenuBox(
                ...
                ExposedDropdownMenu(
                    ...
                    NRootTagMode.values().forEach { mode ->
                        DropdownMenuItem(
            ...
            // Device Selection Dropdown -- only shown in Track mode.
            if (selectedMode == NRootTagMode.TRACK_TARGET) {
                ExposedDropdownMenuBox(
            ...
            Row(
                ...
                if (isRunning) {
                    ...
                    Button(
                        ...
                        enabled = selectedMode != NRootTagMode.TRACK_TARGET || selectedDevice != null,
                        ...
                        Text(
                            when (selectedMode) {
                                NRootTagMode.SCAN_FINDMY_DEVICES -> "START SCAN"
                                NRootTagMode.BROADCAST_FINDMY -> "START BROADCAST"
                                NRootTagMode.TRACK_TARGET -> "START TRACKING"
                            }
                        )
                    }
                }
