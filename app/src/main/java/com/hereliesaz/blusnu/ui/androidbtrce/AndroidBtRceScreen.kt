...
/**
 * Screen for Android BT Stack RCE vulnerability assessment.
 *
 * Tests for multiple Android Bluetooth stack memory corruption vulnerabilities
 * including heap overflows and use-after-free conditions in GATT, HF client,
 * ACL, BTA, and L2CAP layers. Requires root access.
 *
 * @param viewModel State holder for Android BT RCE logic.
 */
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun AndroidBtRceScreen(viewModel: AndroidBtRceViewModel) {
        ...
        Column(
            ...
            Text(
                text = "Tests for Android Bluetooth stack vulnerabilities " +
                        "(CVE-2024-49748, CVE-2025-0075/22403/48593/48539) " +
                        "-- heap overflows and use-after-free in GATT, HF client, " +
                        "and ACL layers.",
            ...
            ExposedDropdownMenuBox(
                ...
                TextField(
                    value = "${selectedVector.cve}: ${selectedVector.description}",
                    onValueChange = {},
                    readOnly = true,
                ...
                ExposedDropdownMenu(
                    ...
                    AndroidRceVector.values().forEach { vector ->
                        DropdownMenuItem(
