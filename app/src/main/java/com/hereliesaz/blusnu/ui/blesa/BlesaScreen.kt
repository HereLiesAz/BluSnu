...
/**
 * Screen for BLESA (BLE Spoofing Attack on Reconnections).
 *
 * Tests BLE reconnection authentication by spoofing a disconnected peripheral
 * to check if the central accepts reconnection without re-authentication.
 */
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun BlesaScreen(viewModel: BlesaViewModel) {
        ...
        Column(
            ...
            Text(
                text = "Tests BLE reconnection authentication -- spoofs a disconnected " +
                        "peripheral to check if the central accepts reconnection " +
            ...
            if (logs.isNotEmpty()) {
                ResultActions(
                    ...
                    label = "BLESA Reconnection Test Results",
