...
/**
 * Screen for BlueTrust Relationship Mapping.
 *
 * Maps Bluetooth pairing relationships between devices by probing connection
 * responses. Identifies device ownership networks and trust hierarchies.
 */
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun BlueTrustScreen(viewModel: BlueTrustViewModel) {
        ...
        Column(
            ...
            Text(
                text = "Maps Bluetooth pairing relationships between devices by probing " +
                        "connection responses. Identifies device ownership networks " +
            ...
            if (logs.isNotEmpty()) {
                ResultActions(
                    ...
                    label = "BlueTrust Mapping Results",
