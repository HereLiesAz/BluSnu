...
/**
 * Screen for BLE Battery Exhaustion.
 *
 * Targeted DoS against battery-powered IoT devices via connection/scan flooding.
 * Forces targets out of power-saving mode to accelerate battery drain.
 */
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun BatteryExhaustionScreen(viewModel: BatteryExhaustionViewModel) {
        ...
        Column(
            ...
            Text(
                text = "Targeted DoS against battery-powered IoT devices via " +
                        "connection/scan flooding. Forces targets out of power-saving " +
                        "mode to accelerate battery drain.",
            ...
            ExposedDropdownMenuBox(
                ...
                ExposedDropdownMenu(
                    ...
                    ExhaustionMode.entries.forEach { mode ->
                        DropdownMenuItem(
            ...
            if (logs.isNotEmpty()) {
                ResultActions(
                    ...
                    label = "BLE Battery Exhaustion Results",
