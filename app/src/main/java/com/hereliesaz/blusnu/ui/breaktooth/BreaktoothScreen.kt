package com.hereliesaz.blusnu.ui.breaktooth
...
/**
 * Screen for Breaktooth (Sleep Mode Session Hijacking).
 *
 * Tests BLE sleep mode session hijacking -- exploits the lack of security
 * notifications on session disconnect and attempts link key overwriting
 * during reconnection.
 */
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun BreaktoothScreen(viewModel: BreaktoothViewModel) {
        ...
        Column(
            ...
            Text(
                text = "Tests BLE sleep mode session hijacking -- exploits the lack of " +
                        "security notifications on session disconnect and attempts link key " +
                        "overwriting during reconnection.",
