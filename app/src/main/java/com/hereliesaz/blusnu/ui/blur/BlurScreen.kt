...
/**
 * Screen for BLUR Attack (CVE-2020-15802).
 *
 * Tests Cross-Transport Key Derivation (CTKD) between BR/EDR and BLE to
 * determine if authentication keys can be overwritten across transports.
 * Targets dual-mode devices. Requires root access.
 */
        ...
        Column(
            ...
            Text(
                text = "Tests Cross-Transport Key Derivation (CTKD) between BR/EDR " +
                        "and BLE to determine if authentication keys can be overwritten " +
                        "across transports. Targets dual-mode devices. Requires root access.",
                style = MaterialTheme.typography.bodyMedium,
                color = MaterialTheme.colorScheme.onSurfaceVariant
            )

            // Device Selection (show address as fallback for null names).
            ExposedDropdownMenuBox(
                ...
                TextField(
                    ...
                    onValueChange = {},
                    readOnly = true,
                    label = { Text("Target Device (Dual-Mode Only)") },
                ...
                ExposedDropdownMenu(
                    ...
                    if (devices.isEmpty()) {
                        DropdownMenuItem(
                            text = { Text("No dual-mode devices found -- run a scan first") },
