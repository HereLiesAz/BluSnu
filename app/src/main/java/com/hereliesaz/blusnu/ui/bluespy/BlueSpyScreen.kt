...
/**
 * Screen for BlueSpy Audio Interception.
 *
 * Connects to audio devices with insecure (Just Works) pairing to test whether
 * microphone audio can be captured without user awareness. Requires root access.
 */
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun BlueSpyScreen(viewModel: BlueSpyViewModel) {
        ...
        Column(
            ...
            Text(
                text = "Connects to audio devices with insecure (Just Works) pairing " +
                        "to test whether microphone audio can be captured without user " +
                        "awareness. Requires root access.",
            ...
            if (logs.isNotEmpty()) {
                ResultActions(
                    ...
                    label = "BlueSpy Audio Interception Results",
