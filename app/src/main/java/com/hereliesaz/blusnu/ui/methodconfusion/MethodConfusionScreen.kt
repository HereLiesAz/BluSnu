...
/**
 * Screen for Method Confusion Attack.
 *
 * Tests pairing method confusion (CVE-2022-25836/25837) by forcing conflicting
 * key establishment methods between pairing devices to enable authenticated MITM.
 */
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun MethodConfusionScreen(viewModel: MethodConfusionViewModel) {
        ...
        Column(
            ...
            Text(
                text = "Tests pairing method confusion (CVE-2022-25836/25837) " +
                        "-- forces conflicting key establishment methods between " +
                        "pairing devices to enable authenticated MITM.",
            ...
            if (logs.isNotEmpty()) {
                ResultActions(
                    ...
                    label = "Method Confusion Attack Results",
