package com.hereliesaz.blusnu.ui.bluefrag
...
/**
 * Screen for the BlueFrag Attack (CVE-2020-0022).
 *
 * Tests for the BlueFrag RCE vulnerability in Android's Bluetooth packet
 * reassembly. Probes L2CAP fragmentation handling to identify susceptible
 * devices (Android 8-10). Requires root access.
 *
 * @param viewModel State holder for BlueFrag attack logic.
 */
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun BlueFragScreen(viewModel: BlueFragViewModel) {
        ...
        Column(
            ...
            Text(
                text = "Tests for the BlueFrag RCE vulnerability in Android's Bluetooth " +
                        "packet reassembly. Probes L2CAP fragmentation handling to identify " +
                        "susceptible devices (Android 8-10).",
