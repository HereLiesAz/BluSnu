...
/**
 * Screen for Stealtooth Pairing Attack.
 *
 * Tests whether a device accepts silent automatic re-pairing, which could
 * allow an attacker to overwrite legitimate link keys and enable future
 * MitM attacks. Requires root access.
 */
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun StealtoothScreen(viewModel: StealtoothViewModel) {
        ...
        Column(
            ...
            Text(
                text = "Tests whether a device accepts silent automatic re-pairing, " +
                        "which could allow an attacker to overwrite legitimate link keys " +
                        "and enable future MitM attacks. Requires root access.",
            ...
            if (logs.isNotEmpty()) {
                ResultActions(
                    ...
                    label = "Stealtooth Attack Results",
