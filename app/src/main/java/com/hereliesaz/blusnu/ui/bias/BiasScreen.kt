...
/**
 * Screen for the BIAS attack (Bluetooth Impersonation AttackS).
 *
 * Tests whether a device is vulnerable to Bluetooth impersonation by
 * probing authentication enforcement, role switching, and Secure
 * Connections requirements. Requires root access.
 *
 * @param viewModel State holder for BIAS attack logic.
 */
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun BiasScreen(viewModel: BiasViewModel) {
        ...
        Column(
            ...
            Text(
                text = "Tests whether a device is vulnerable to Bluetooth Impersonation " +
                        "Attacks by probing authentication enforcement, role switching, " +
                        "and Secure Connections requirements. Requires root access.",
            ...
            // Action buttons with stop capability.
            Row(
                modifier = Modifier.fillMaxWidth(),
