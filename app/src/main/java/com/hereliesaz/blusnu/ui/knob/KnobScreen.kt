...
/**
 * Screen for the KNOB Attack (Key Negotiation of Bluetooth).
 *
 * Tests whether a target device accepts reduced encryption key entropy
 * during BR/EDR key negotiation (CVE-2019-9506). Requires root access.
 *
 * @param viewModel State holder for KNOB attack logic.
 */
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun KnobScreen(viewModel: KnobViewModel) {
        ...
        Column(
            ...
            Text(
                text = "Tests whether a device accepts reduced encryption key entropy " +
                        "during key negotiation. A successful KNOB attack forces a 1-byte " +
                        "key, making brute-force trivial. Requires root access.",
