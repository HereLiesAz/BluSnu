...
/**
 * Screen for Mesh Provisioning Attack.
 *
 * Tests Bluetooth Mesh provisioning security by exploiting Malleable Commitment
 * and Authentication Reflection vulnerabilities in Mesh Profile 1.0 to gain
 * network access.
 *
 * @param viewModel State holder for Mesh Provisioning attack logic.
 */
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun MeshProvisioningScreen(viewModel: MeshProvisioningViewModel) {
        ...
        Column(
            ...
            Text(
                text = "Tests Bluetooth Mesh provisioning security -- exploits " +
                        "Malleable Commitment and Authentication Reflection " +
                        "vulnerabilities in Mesh Profile 1.0 to gain network access.",
            ...
            ExposedDropdownMenuBox(
                ...
                ExposedDropdownMenu(
                    ...
                    MeshAttackMode.values().forEach { mode ->
                        DropdownMenuItem(
            ...
            if (logs.isNotEmpty()) {
                ResultActions(
                    ...
                    label = "Mesh Provisioning Attack Results",
